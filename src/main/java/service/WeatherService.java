...
public class WeatherService {
    public static WeatherData getWeatherData(String cityName) throws IOException {
    WeatherData weatherData = new WeatherData();
    String cityUrl = cityName;
    City city = new City();
    ObjectMapper mapper = new ObjectMapper();

    URL www = new URL("http://api.openweathermap.org/data/2.5/weather?q="+cityUrl+"&APPID=e0b05909c4c74435ac5117ce6d06f0f8");
